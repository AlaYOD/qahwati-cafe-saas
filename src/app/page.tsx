  ...
  return (
    <>
      ...
      <header className="fixed top-0 z-50 w-full border-b border-primary/20 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md px-6 lg:px-20 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 text-primary">
            <span className="material-symbols-outlined text-3xl font-bold">coffee</span>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-10 pointer-events-none" data-alt="Subtle geometric pattern background representing coffee beans" style={{ backgroundImage: "radial-gradient(circle at 2px 2px, #866765 1px, transparent 0)", backgroundSize: "40px 40px" }}></div>
        {/* Gradient Background */}
      ...
      {/* Features Section */}
      <section className="py-24 px-6 lg:px-20 bg-background-light dark:bg-[#1f1c1c]" id="features">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group p-8 rounded-2xl border border-primary/10 bg-background-light dark:bg-background-dark hover:border-primary/40 transition-all">
              <div className="size-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-white transition-colors text-primary">
                <span className="material-symbols-outlined text-3xl">order_approve</span>
              </div>
      ...
      {/* Pricing Section */}
      <section className="py-24 px-6 lg:px-20 bg-background-light dark:bg-background-dark" id="pricing">
        <div className="max-w-7xl mx-auto">
      ...
      {/* Footer */}
      <footer className="py-12 px-6 lg:px-20 border-t border-primary/10">
